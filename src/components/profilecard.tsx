...
export const KProfileCard = () => {
  return (
    <div className="relative mx-auto w-full max-w-[760px] md:mt-12 md:h-[1400px] md:max-w-[1344px]">
      <div className="flex flex-col items-center md:block">
        ...
        <div className="mt-3 inline-flex flex-col items-center justify-start gap-1 text-center md:absolute md:left-1/2 md:top-[275px] md:mt-0 md:-translate-x-1/2 md:gap-2">
          ...
          <div className="inline-flex w-44 items-center justify-center gap-2.5 md:w-[420px] md:gap-5">
            <div className="text-xs font-normal text-rose-500/60 md:text-2xl">12324001</div>
            <div className="h-[3px] w-[3px] rounded-full bg-rose-500 md:h-[6px] md:w-[6px]" />
            <div className="text-xs font-normal text-rose-500/60 md:text-2xl">kedokteran</div>
          </div>
        </div>
        ...
        <div className="mt-6 inline-flex w-full flex-col items-start justify-start gap-5 md:absolute md:left-0 md:top-[380px] md:mt-0 md:gap-10">
          <div className="flex w-full flex-col items-center justify-start gap-4 rounded-[40px] bg-rose-500/20 px-4 py-4 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] md:w-[90%] md:self-center md:gap-6 md:px-8 md:py-5">
            ...
            <div className="self-stretch text-center text-xs font-normal text-cyan-700 md:text-[22px] md:leading-[1.35]">
        ...
        <div className="mt-5 inline-flex items-center justify-center gap-8 text-center md:absolute md:left-1/2 md:top-[1100px] md:mt-0 md:block md:h-10 md:w-[90%] md:-translate-x-1/2">
          <div className="text-xs font-normal text-rose-500/60 underline md:absolute md:left-32 md:top-1/2 md:-translate-y-1/2 md:text-[24px]">PORTOFOLIO</div>
          ...
          <div className="text-xs font-normal text-rose-500/60 underline md:absolute md:right-32 md:top-1/2 md:-translate-y-1/2 md:text-[24px]">@username</div>
        </div>
      </div>
    </div>
  );
